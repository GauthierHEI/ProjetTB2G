...
public class UtilisateurDaoTestCase {
    ...
    public void initDb() throws Exception {
        try (Connection connection = DataSourceProvider.getDataSource().getConnection();
            ...
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Tshirt Gris',10,10,10,9.99,1,'Gris','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Pull Gris',10,10,10,19.99,2,'Gris','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Chemise Blanche',10,10,10,14.99,3,'Blanc','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Tshirt Blanc',10,10,10,9.99,1,'Blanc','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Tshirt Rouge',10,10,10,9.99,1,'Rouge','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Tshirt Bleu',10,10,10,9.99,1,'Bleu','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Pull Bleu',10,10,10,19.99,2,'Bleu','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Pull Rouge',10,10,10,19.99,2,'Rouge','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Chemise Bleue',10,10,10,14.99,3,'Bleu','');");
            stmt.executeUpdate("INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`) VALUES ('Tshirt Noir',10,10,10,9.99,1,'Noir','');");

            stmt.executeUpdate("INSERT INTO `utilisateur` (`email`,`prenom`,`nom`,`datenaissance`,`motdepasse`,`adresseliv`,`adressefac`,`admin`) VALUES ('gauthier.hacout@hei.yncrea.fr','Alex','Alex','1997-10-21','$argon2i$v=19$m=65536,t=5,p=1$QvOv3+9qSYxIzLlzjeJKc8qpT9PJ42y9B+U/hXBejlB3mSghQ75TcJemyV2X51pN2sWspKHwqgWXtddCykMUsWBajRljlm9EJEPRZhhOi4TjkUsqcbto8ToE3ih7FiBIt4sQF1pMW4BwoXZOtQ1/jc6p53h2zmOJ6szzuzhQlC0$lqf32VJjfnSEeu2Nnnck0nTrpWJuhmpSa/XPx86cBjpgj2UCR4fSCoeeffXj4i4eEV/RKIidgzbW4tUJ07VfDA1khGZ+N+/6IC21QM+jcPdhCQd2wFOS6T3vHGj+2Gw5yFREJeh9wSZTf+lAZtFKGS3Ca1E6EJSlQBgtAzJlzz0','10 rue Adolphe','10 rue Adolphe',false);");
