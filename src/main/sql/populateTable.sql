...
INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`,`Hexcouleur`) VALUES ('Tshirt Bleu',10,10,10,9.99,1,'Bleu','MannequinTshirt.jpg','#3b5998');
INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`,`Hexcouleur`) VALUES ('Pull Bleu',10,10,10,19.99,2,'Bleu','MannequinPull.jpg','#3b5998');
INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`,`Hexcouleur`) VALUES ('Pull Rouge',10,10,10,19.99,2,'Rouge','MannequinPull.jpg','#ff4444');
INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`,`Hexcouleur`) VALUES ('Chemise Bleue',10,10,10,14.99,3,'Bleu','MannequinChemise.jpg','#3b5998');
INSERT INTO `produit` (`produit`,`dispoS`,`dispoM`,`dispoL`,`prix`,`cat`,`couleur`,`image`,`Hexcouleur`) VALUES ('Tshirt Noir',10,10,10,9.99,1,'Noir','MannequinTshirt.jpg','#000000');
